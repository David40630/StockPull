...
!define MULTIUSER_INSTALLMODE_INSTDIR "StockPull"
...
Section "!${PRODUCT_NAME}" sec_app
  ...
  SetOutPath "%HOMEDRIVE%\%HOMEPATH%"
    CreateShortCut "$SMPROGRAMS\StockPull.lnk" "$INSTDIR\Python\pythonw.exe" \
      '"$INSTDIR\StockPull.launch.pyw"' "$INSTDIR\main.ico"
  SetOutPath "$INSTDIR"
...
Section "Uninstall"
  ...
  ; Uninstall directories
    ...
    RMDir /r "$INSTDIR\src2"

  ; Uninstall shortcuts
      Delete "$SMPROGRAMS\StockPull.lnk"
  RMDir $INSTDIR
